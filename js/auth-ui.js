...
function mountAuthUI() {
  ...
  wrap.innerHTML = `
    <style>
      ...
      .ty-auth-right{display:flex;align-items:center;gap:5px;margin-left:auto!important;order:2}
      ...
      .ty-auth-links a:first-of-type:before{content:"🪔";font-size:14px}
      .ty-auth-links a:nth-of-type(2):before{content:"🛕";font-size:14px}
      ...
      @media(max-width:600px){.ty-auth-bar{top:8px;right:8px;left:8px;justify-content:space-between;border-radius:14px}.ty-auth-right{flex-wrap:wrap;justify-content:space-between}.ty-auth-links{order:1}.ty-auth-user{order:2;display:flex;gap:5px;align-items:center}.ty-auth-right a,.ty-auth-right button,#ty-logout-btn,#ty-user-label{padding:6px 8px;font-size:11px}}
    </style>
    <div class="ty-auth-bar">
      <button id="ty-logout-btn" type="button" hidden>Logout</button>
      <span class="ty-auth-right">
        <span class="ty-auth-links"><a href="prasads.html" title="Explore Prasads">Prasads</a>
        <a href="temple-visits.html" title="Explore Temple Visits">Temple Visits</a></span>
        <span class="ty-auth-user"><span id="ty-user-label">Guest</span>
