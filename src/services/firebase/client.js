...
export { onAuthStateChanged, signInWithPopup, signOut, createUserWithEmailAndPassword, signInWithEmailAndPassword, updateProfile, ref, get, set, push, update, onValue };
...
export async function ensureUserProfile(user) {
  ...
  if (!snap.exists()) {
    ...
    await update(userRef, { ...base, role: existing.role || "user", createdAt: existing.createdAt || Date.now() });
  }
